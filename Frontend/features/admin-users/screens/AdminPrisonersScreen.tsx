...
export default function AdminPrisonersPage() {
  ...
  const toUser = (prisoner: AdminPrisoner): AdminUser => ({ accountReference: prisoner.publicId ?? prisoner.user.email ?? '', publicId: prisoner.publicId, name: prisoner.name, email: prisoner.user.email, role: 'PRISONER', isActive: prisoner.user.isActive, createdAt: prisoner.createdAt, updatedAt: prisoner.updatedAt });
