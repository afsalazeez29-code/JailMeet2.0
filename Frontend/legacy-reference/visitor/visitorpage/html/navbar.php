            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="userlogo.webp" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-muted">Visitor ID: <?php echo htmlspecialchars($visitor_id); ?></small>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <!-- Passing visitor_id via URL -->
                        <a class="dropdown-item" href="profile.php?vid=<?php echo urlencode($visitor_id); ?>">
