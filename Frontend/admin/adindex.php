...
$logged_in_username = isset($_SESSION['ad_name']) ? $_SESSION['ad_name'] : 'Admin'; // Default to 'Admin' if not set
    ...
    <div class="container" style="position:absolute; top:70px">
          <div class="page-inner">
            ...
            <div class="ms-md-auto py-2 py-md-0">
              <a href="officersdetails.php" class="btn btn-label-info btn-round me-2">Add Officer</a>
              <a href="userdetails.php" class="btn btn-primary btn-round">Add Visitor</a>
            </div>
          </div>
          <!-- Display the logged-in ID -->
          <div class="alert alert-info">
            Welcome, Admin ID: <strong><?php echo htmlspecialchars($logged_in_id); ?></strong>
          </div>
            <div class="row">
